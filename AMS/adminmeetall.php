...
<tr>
  ...
  <td><font color=white>UPLOAD IMAGE</font></td>
</tr>
<?php
	$con = mysqli_connect('localhost', 'root', '');
    mysqli_select_db($con, 'amsdb');
	$query = 'SELECT meetings.mid,meetings.mhead,meetings.mdesc,meetings.mdate,meetings.mtime,meetings.mbooking,meetings.mcname,meetings.mcmob FROM meetings  ';
$result = mysqli_query($con, $query);
$row=mysqli_fetch_row($result);
while($row)
{
	print("<tr><td><font color=white>$row[0]</font></td><td><font color=white>$row[1]</font></td><td><font color=white>$row[2]</font></td><td><font color=white>$row[3]</font></td><td><font color=white>$row[4]</font></td><td><font color=white>$row[5]</font></td><td><font color=white>$row[6]</font></td><td><font color=white>$row[7]</font></td>");
	print("<td><a href=adminmeetdel.php?mid=$row[0]>delete</a></td>");
	print("<td><a href=adminmeetedit.php?mid=$row[0]>edit</a></td>");
  print("<td><a href=adminimageupload.php?mid=$row[0]>upload</a></td>");
	print("</tr>");
	$row=mysqli_fetch_row($result);
}
?>
